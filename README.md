...
- Running local LLMs through real agent loops and writing down where they break — [agent-lab](https://github.com/gbfish/agent-lab). Every conclusion in that repo is traceable to a raw trajectory; if a number isn't backed by a run, it isn't in the README.
